...
public class FileTest {
    public static void main(String[] args) throws IOException {
        Path namesPath = Path.of("/home/mohit/Desktop/takeuforward/design-striver.patterns/src/names.txt");

        Path namesPath2 = Path.of("/home/mohit/Desktop/takeuforward/design-striver.patterns/src").resolve("names.txt");
